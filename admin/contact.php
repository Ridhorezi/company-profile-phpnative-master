                    ...
                    <table class="table table-striped" id="tabel-data">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="contact_input.php?id=<?php echo $r1['id']?>">
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <!-- Ini adalah Bagian Footer Modal -->
                                            <div class="modal-footer">
                                                ...
                                                <a href="contact.php?op=delete&id=<?php echo $r1['id'] ?>">
                ...
                <!-- <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        ...
                        for($i=1; $i <= $pages; $i++){
                            ?>
                            <li class="page-item">
                                <a class="page-link" href="contact.php?katakunci=<?php echo $katakunci?>&cari=<?php echo $cari?>&page=<?php echo $i ?>"><?php echo $i ?></a>
                            </li>
                            <?php
                            }
                        ?>
